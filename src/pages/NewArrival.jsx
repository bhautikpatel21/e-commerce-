...
import { getNewArrivalProducts, addToCart, getWishlist, addToWishlist, removeFromWishlist } from '../Api'
  ...
  useEffect(() => {
    const fetchNewArrivalProducts = async () => {
      try {
        ...
        setError(err.message || 'Failed to load new arrival products')
      } finally {
        setLoading(false)
      }
    }
    ...
    <div className="page-shell">
      ...
      <main>
        ...
        {productsData.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '50px' }}>
            <p>No new arrival products available at the moment.</p>
          </div>
        ) : (
          <section
